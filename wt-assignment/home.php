    ...
    <center>
        <div class="container">
            ...
            <div id="hh" class="jumbotron z-depth-0">
                <h1 class="wow bounceInDown" ><span id="b1">Anime </span> <span id="b2">>|<</span> <span id="b1"> Manga<span></h1>      
            </div>
        </div>
    </center>
    ...
    <div class="container-fluid fixed-bottom">
        <div class="btn-group dropup float-right">
            ...
            <div class="dropdown-menu z-depth-2 animated fadeIn" style="border-radius: 100px;padding:10px">
                <a class="dropdown-item nav-elevate" href="share.php">Share your Post</a>
