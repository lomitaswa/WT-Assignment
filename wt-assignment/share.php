...
<html lang="en">
<head>
    <title>Share | Anime Manga</title>
    <meta charset="UTF-8">
    <meta name="viewport" content="width=device-width, initial-scale=1.0">
    <meta name="description" content="Login | sending/validating credentials to/with DB">
        ...
        <div class="row">
            <div class="col-lg-6 offset-lg-3 mt-4 mb-4">
                ...
                <form action="project_submit.php" method="POST" class="text-center p-5 mb-4 z-depth-3" style="border: 1px solid #e3f2fd;margin-top: 30px;">
                    ...
                    <!-- Project Name -->
                    <input type="text" name="pname" class="form-control mt-4" placeholder="Post Name" required>
                    <!--Project Type-->
                    ...
                    <input type="url" name="link" class="form-control mb-4" placeholder="post-link" required>   
                    <!-- Sign in button -->
                    <button class="btn btn-info waves-light my-4" type="submit">Post</button>  
                </form>
                <!-- Default form login -->
            </div>
        </div>
