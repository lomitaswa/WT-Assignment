	...
	<div class="container-fluid">
		<div class="row">
			...
			<div class="col-lg-6 mb-4 ml-lg-4 text-center" style="position: fixed;margin-top: 50px;">
				<img src="img/join_us1.png" atl="signup flaticon" class="img-fluid animated zoomInUp mt-4" height="75%" width="50%">
				<p class="mt-4" style="font-size: 40px;">Join Us.... Know Us...</p>
			</div>
			<div class="col-lg-4">
			...
			<div class="col-lg-5 offset-lg-2 mt-4">
				...
				<form action="signup_submit.php" method="POST" class="text-center p-5 mt-4 mb-4 z-depth-3" style="border: 1px solid #e3f2fd;background-color: #fff;">
					<h1 class="mt-2 mb-4" style="color: #ed4e15;font-weight: bold;"><span style="color: #e81212;">Sign</span> up</h1>
